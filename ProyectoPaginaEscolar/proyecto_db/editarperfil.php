...
<style type="text/css">
	container {
		...
		border-style : solid ;
		border-width: 5px;
		border-image: initial; border: 1px solid black;
		whith : 50 px ;
		height: 100 px;
...
<?php if(isset($_POST['editar'])) {
	...
	$sql = mysqli_query($connect,"UPDATE usuario SET usuario = '".$usuario."', contrasena = '".$contrasena."', avatar = '".$destino1."' WHERE id = '".$_GET['id']."'");
